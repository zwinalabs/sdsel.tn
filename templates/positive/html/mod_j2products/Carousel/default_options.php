	...
	<div id="j2option-<?php echo $option['productoption_id']; ?>"
		class="option">
          ...
          <input <?php echo $checked; ?> type="radio"
			...
			id="j2option-value-<?php echo $option_value['product_optionvalue_id']; ?>"
          ...
          <?php endif; ?>
          <label
			for="j2option-value-<?php echo $option_value['product_optionvalue_id']; ?>"><?php echo stripslashes(htmlspecialchars(JText::_($option_value['optionvalue_name']))); ?>
            <?php if ($option_value['product_optionvalue_price'] > 0 && $j2params->get('product_option_price', 1)) { ?>
	         	(
	         	<?php if($j2params->get('product_option_price_prefix', 1)): ?>
            		<?php echo $option_value['product_optionvalue_prefix']; ?>
