...
<form
	...
	<?php if($this->params->get('list_show_filter_price', 0) && isset($this->filters['pricefilters']) && count($this->filters['pricefilters'])): ?>
		...
		?>
		<div id="j2store-price-filter-container" class="t3-module j2store-product-filters price-filters"  >
			<h3 class="module-title  product-filter-heading"><span><?php echo JText::_('J2STORE_PRODUCT_FILTER_PRICE_TITTLE'); ?></span></h3>
			...
			<div id="j2store-slider-range-box" class="price-input-box" >
				<input class="btn btn-success" type="submit"   id="filterProductsBtn"  value="<?php echo JText::_('J2STORE_FILTER_GO');?>" />
					<div class="pull-right jb-price-range">
	...
	<div class="t3-module j2store-product-filters category-filters"  >
		<h3 class="module-title product-filter-heading"><span><?php echo JText::_('J2STORE_PRODUCT_FILTER_CATEGORY_TITTLE'); ?></span></h3>
		<?php
