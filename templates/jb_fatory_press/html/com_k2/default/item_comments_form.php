...
<div class="section-title">
		<h3 class="module-title"><span><?php echo JText::_('K2_LEAVE_A_COMMENT') ?></span></h3>
</div>
...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">
	...
	<button type="submit" class="button-main btn btn-primary hvr-sweep-to-rightB buy_theme" id="submitCommentButton" ><?php echo JText::_('K2_SUBMIT_COMMENT'); ?></button>
