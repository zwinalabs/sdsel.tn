...
function sp_ajax_contact_addon($atts){
	...
	$output  = '<div class="sppb-addon sppb-addon-ajax-contact home-contact-form contact-form' . $class . '">';
	...
	$output .= '<div class="sppb-form-group col-md-6">';
	...
	$output .= '<div class="sppb-form-group col-md-12">';
	...
	$output .= '<div class="sppb-form-group col-md-12">';
	$output .= '<button type="submit" class="sppb-btn  btn btn-primary"><i class="fa"></i> '. JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SEND') .'</button>';
	$output .= '</div>';
