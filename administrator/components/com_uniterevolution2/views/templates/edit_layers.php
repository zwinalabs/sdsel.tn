	...
	<div class="edit_slide_wrapper<?php echo ($slide->isStaticSlide()) ? ' rev_static_layers' : ''; ?>">
		...
		if(!$slide->isStaticSlide()){
			...
			<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
				<h3 class="box-closed tp-accordion">
					<span class="postbox-arrow2">-</span><span><?php _uge("Slider Main Image / Background",REVSLIDER_TEXTDOMAIN) ?></span>
				</h3>
				<div class="toggled-content">
					<div class="inner_wrapper p10 pb0 pt0 boxsized">
						<div class="editor_buttons_wrapper_top">
							<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:10px 0px 0px;"><?php _uge("Background Source:",REVSLIDER_TEXTDOMAIN)?></h3>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"  for="radio_back_image"><?php _uge("Image BG",REVSLIDER_TEXTDOMAIN)?></label>
							<!-- THE BG IMAGE CHANGED DIV -->
							<div id="tp-bgimagewpsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
								<a href="javascript:void(0)" id="button_change_image" class="button-primary revblue <?php if($bgType != "image") echo "button-disabled" ?>" style="margin-bottom:5px"><?php _uge("Change Image",REVSLIDER_TEXTDOMAIN)?></a>
							</div>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_external"><?php _uge("External URL",REVSLIDER_TEXTDOMAIN)?></label>
							...
							<div id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
								...
								<a href="javascript:void(0)" id="button_change_external" class="button-primary revblue <?php if($bgType != "external") echo "button-disabled" ?>" style="margin-bottom:5px"><?php _uge("Get External",REVSLIDER_TEXTDOMAIN)?></a>
							</div>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_trans"><?php _uge("Transparent",REVSLIDER_TEXTDOMAIN)?></label>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_solid"><?php _uge("Solid Colored",REVSLIDER_TEXTDOMAIN)?></label>
							...
							<div id="tp-bgimagesettings" class="bgsrcchanger-div" style="margin-top:10px;display:none">
								<div id="bg-setting-wrap">
									<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px;"><?php _uge("Background Settings:",REVSLIDER_TEXTDOMAIN)?></h3>
									<label for="slide_bg_fit"><?php _uge("Background Fit:",REVSLIDER_TEXTDOMAIN)?></label>
									...
									<label for="slide_bg_repeat"><?php _uge("Background Repeat:",REVSLIDER_TEXTDOMAIN)?></label>
									...
									<label for="slide_bg_position" id="bg-position-lbl"><?php _uge("Background Position:",REVSLIDER_TEXTDOMAIN)?></label>
								...
								<div style="clear:both"></div>
								<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px; float: left;"><?php _uge("Ken Burns / Pan Zoom Settings:",REVSLIDER_TEXTDOMAIN)?></h3>

								<div style="margin-top: 15px; margin-left: 10px; float: left;">
									<input type="radio" name="kenburn_effect" value="on" <?php echo ($kenburn_effect == 'on') ? 'checked="checked"' : ''; ?> /> <?php _uge("On",REVSLIDER_TEXTDOMAIN)?>&nbsp;&nbsp;<input type="radio" name="kenburn_effect" value="off" <?php echo ($kenburn_effect == 'off') ? 'checked="checked"' : ''; ?> /> <?php _uge("Off",REVSLIDER_TEXTDOMAIN)?>
								</div>
								<div class="clear"></div>
								...
								<table id="kenburn_wrapper" <?php echo ($kenburn_effect == 'off') ? 'style="display: none;"' : ''; ?>>
									<tr>
										...
										<td></td>
										<td>&nbsp;<?php //_uge("Start",REVSLIDER_TEXTDOMAIN)?></td>
		...
		<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
			<h3 class="box-closed tp-accordion">
				<span><?php if($slide->isStaticSlide()){ _uge("Static / Global Layers",REVSLIDER_TEXTDOMAIN); }else{ ?><?php _uge("Slide",REVSLIDER_TEXTDOMAIN); }?></span>
			</h3>
			<div class="layer-editor-toolbar">
				<span class="setting_text_3"><?php _uge("Helper Grid:",REVSLIDER_TEXTDOMAIN) ?></span>
				<select name="rs-grid-sizes" id="rs-grid-sizes">
					<option value="1"><?php _uge("Disabled",REVSLIDER_TEXTDOMAIN) ?></option>
				...
				<span class="setting_text_3"><?php _uge("Snap to:",REVSLIDER_TEXTDOMAIN) ?></span>
				<select name="rs-grid-snapto" id="rs-grid-snapto">
					<option value=""><?php _uge("None",REVSLIDER_TEXTDOMAIN) ?></option>
					<option value=".helplines"><?php _uge("Help Lines",REVSLIDER_TEXTDOMAIN) ?></option>
					<option value=".slide_layer"><?php _uge("Layers",REVSLIDER_TEXTDOMAIN) ?></option>
				</select>
				...
				if($slide->isStaticSlide()){
					...
					?>
					<span class="setting_text_3"><?php _uge("Show Layers from Slide:",REVSLIDER_TEXTDOMAIN) ?></span>
				...
				<div class="inner_wrapper p10 pb0 pt0 boxsized">
					...
					<div class="editor_buttons_wrapper_bottom">
						<div style="float:left">
							<a href="javascript:void(0)" id="button_add_layer" 		 data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-layers-alt"></i><?php _uge("Add Layer",REVSLIDER_TEXTDOMAIN)?></a>
							<a href="javascript:void(0)" id="button_add_layer_image" data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-picture-1"></i><?php _uge("Add Layer: Image",REVSLIDER_TEXTDOMAIN)?> </a>
							<a href="javascript:void(0)" id="button_add_layer_video" data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-video"></i><?php _uge("Add Layer: Video",REVSLIDER_TEXTDOMAIN)?> </a>							
							<a href="javascript:void(0)" id="button_duplicate_layer" class="button-primary revyellow button-disabled"><i class="revicon-picture"></i><?php _uge("Duplicate Layer",REVSLIDER_TEXTDOMAIN)?></a>
						</div>
						<div style="float:right;">
							<a href="javascript:void(0)" id="button_delete_layer"    class="button-primary  revred button-disabled"><i class="revicon-trash"></i><?php _uge("Delete Layer",REVSLIDER_TEXTDOMAIN)?></a>
							<a href="javascript:void(0)" id="button_delete_all"      class="button-primary  revred button-disabled"><i class="revicon-trash"></i><?php _uge("Delete All Layers",REVSLIDER_TEXTDOMAIN)?> </a>
						</div>
					</div>
				</div>
				<div class="clear"></div>
				...
				<div class="edit_layers_right" style="position:relative;height:100%">
					<div class="postbox unite-postbox layer_sortbox" style="height:100%;">
						...
						<h3 class="no-accordion">
							<span><?php _uge("Layers Timing & Sorting",REVSLIDER_TEXTDOMAIN)?></span>																																				
						</h3>
						<div style="display:table; line-height:30px">
							<div style="display:table-cell; padding:10px 15px; min-width:45px;"><?php _uge("z-Index",REVSLIDER_TEXTDOMAIN)?></div>
							<div style="display:table-cell; min-width:78px">
								<div id="button_sort_visibility" class="tipsy_enabled_top" title="<?php _uge('Hide All Layers',REVSLIDER_TEXTDOMAIN)?>"><i class="eg-icon-eye"></i><i class="eg-icon-eye-off"></i></div>
								<div id="button_sort_lock" class="tipsy_enabled_top" title="<?php _uge('Lock All Layers',REVSLIDER_TEXTDOMAIN)?>"><i class="eg-icon-lock-open"></i><i class="eg-icon-lock"></i></div>	
								<div id="button_sort_tillend" class="tipsy_enabled_top" title="<?php _uge('Snap to Slide End / Custom End',REVSLIDER_TEXTDOMAIN)?>"><i class="eg-icon-back-in-time"></i></div>											
							</div>
							<div style="display:table-cell;padding:10px 15px 10px 0px;width:100%"><?php _uge("Timing",REVSLIDER_TEXTDOMAIN)?>
								<div id="button_sort_timing" class="button-primary revblue" style="margin-left:15px !important" title="<?php _uge('Show / Hide Timer Settings',REVSLIDER_TEXTDOMAIN)?>"><i class="eg-icon-equalizer"></i> <span class="onoff"> - on</span></div>
							</div>									
							<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:50px;"><?php _uge("Start",REVSLIDER_TEXTDOMAIN)?></div>									
							<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:54px;"><?php _uge("End",REVSLIDER_TEXTDOMAIN)?></div>																		
						</div>									
				...
				<div class="edit_layers_left">
					...
					<form name="form_layers" id="form_layers">
						...
						<div class='settings_wrapper' style="<?php echo $show_static; ?>">
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
									<span><?php _uge("Static Options",REVSLIDER_TEXTDOMAIN)?> </span>
								</h3>
								<div class="toggled-content tp-closeifotheropen">
									<ul class="list_settings">
										...
										<div id="layer_static_wrapper"<?php echo ($isTemplate == "true") ? ' style="display: none;"' : ''; ?>>
											<li>
												<div id="static_start_on_wrap" class="setting_text"><?php _uge('Start on Slide', REVSLIDER_TEXTDOMAIN); ?></div>
											...
											<div class="clear"></div>
											<li>
												<div id="static_end_on_wrap" class="setting_text"><?php _uge('End on Slide', REVSLIDER_TEXTDOMAIN); ?></div>
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
									<span><?php _uge("Layer General Parameters",REVSLIDER_TEXTDOMAIN)?> </span>
								</h3>
								<div class="toggled-content tp-closeifotheropen">
									<ul class="list_settings">
										<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Layer Content",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<?php
										...
										?>
										<li style="clear:both">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Align, Position & Styling",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										...
										<li id="layer_scale_title_row" style="clear:both;">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Image Scale (dimensions in pixel)",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<a id="reset-scale" class="revred button-primary" href="javascript:void(0);"><?php echo _uge("Reset Size",REVSLIDER_TEXTDOMAIN)?></a>
										<?php
										...
										<li id="layer_2d_title_row" style="clear:both;">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Final Rotation",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<div style="clear: both;">
											<?php
										...
										<div id="parallax_wrapper_div" style="<?php echo $show_parallax; ?>">
											<li id="parallax_title_row" style="clear:both;">
												<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Parallax Setting",REVSLIDER_TEXTDOMAIN)?></span>
											</li>
											<?php
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
									<span><?php _uge("Layer Animation",REVSLIDER_TEXTDOMAIN)?> </span>
								</h3>
								<div class="toggled-content tp-closedatstart tp-closeifotheropen">
									<ul class="list_settings">
										...
										<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Preview Transition (Star end Endtime is Ignored during Demo)",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										...
										<li id="end_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Start Transition",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<div class="layer-animations">
											...
											<a href="javascript:void(0)" id="add_customanimation_in" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php _uge("Custom Animation",REVSLIDER_TEXTDOMAIN)?></a>
											<div class="clear"></div>
											<?php
										...
										<!--LAYER END ANIMATION -->
										<li id="end_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("End Transition (optional)",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<div class="layer-animations">
										<div style="float:left;margin-right:10px;"><?php
											...
											<a href="javascript:void(0)" id="add_customanimation_out" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php _uge("Custom Animation",REVSLIDER_TEXTDOMAIN)?></a>
											<div class="clear"></div>
											<?php
										...
										<li id="loop_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Loop Animation",REVSLIDER_TEXTDOMAIN)?></span>
										</li>
										<?php
						...
						<div id="layeranimeditor_wrap" title="Layer Animation Editor" style="display:none;margin-bottom:0px; padding-bottom:0px;">
							...
							<div class="settings_wrapper">
								<div class="postbox unite-postbox">
									<h3 class="no-accordion tp-accordion">
										<span style="font-size:13px;padding-left:4px;"><i class="revicon-equalizer"></i><?php _uge("Layer Animation Settings Panel",REVSLIDER_TEXTDOMAIN)?></span>
										<span style="float: right;"><a href="javascript:void(0);" style="margin-top:-7px;border: none;font-weight: 400;box-shadow: none;-webkit-box-shadow: none;-moz-box-shadow: none;" id="set-random-animation" class="button-primary revgreen"><i class="eg-icon-shuffle"></i><?php _uge("Randomize",REVSLIDER_TEXTDOMAIN)?></a></span>
									</h3>
									...
									<table style="border-spacing:0px">
										...
										<tr class="css-edit-title graybasicbg" ><td colspan="6" style="padding:10px"><?php _uge("Transition",REVSLIDER_TEXTDOMAIN)?></td></tr>
										...
										<tr class="css-edit-title"><td colspan="6" style="padding:10px"><?php _uge("Rotation",REVSLIDER_TEXTDOMAIN) ?></td></tr>
										<tr>
											<td><?php _uge("X:",REVSLIDER_TEXTDOMAIN) ?></td>
											<td style="padding-bottom:15px">
									...
									<table style="border-spacing:0px">
										...
										<tr class="css-edit-title graybasicbg">
											<td colspan="4" style="padding:10px"><?php _uge("Scale",REVSLIDER_TEXTDOMAIN) ?></td>
											<td colspan="4" style="padding:10px;padding-left:20px"><?php _uge("Skew",REVSLIDER_TEXTDOMAIN) ?></td>
										</tr>
									...
									<table style="border-spacing:0px padding-bottom:10px">
										...
										<tr class="css-edit-title">
											<td colspan="2" style="padding:10px"><?php _uge("Opacity",REVSLIDER_TEXTDOMAIN)?></td>
											<td colspan="2" style="padding:10px;padding-left:20px"><?php _uge("Perspective",REVSLIDER_TEXTDOMAIN)?></td>
											<td colspan="2" style="padding:10px;padding-left:20px"><?php _uge("Origin",REVSLIDER_TEXTDOMAIN)?></td>
										</tr>
							...
							<div class="settings_wrapper">
								<div class="postbox unite-postbox">
									<h3 class="no-accordion tp-accordion">
										<span style="font-size:13px;padding-left:4px;"><i class="eg-icon-tools"></i><?php _uge("Test Parameters",REVSLIDER_TEXTDOMAIN)?></span>
										<span style="font-size: 9px;text-align: right;font-weight: 300;font-style: italic;white-space: nowrap;"><?php _uge("*These Settings are only for Customizer. Settings can be set per Start and End Animation.",REVSLIDER_TEXTDOMAIN)?></span>
									</h3>
										...
										<div id="caption-inout-controll" class="caption-inout-controll">
											<i id="revshowmetheinanim" class="revicon-login reviconinaction"></i><i id="revshowmetheoutanim" class="revicon-logout"></i><?php _uge("Transition Direction",REVSLIDER_TEXTDOMAIN)?>
										</div>
						...
						<div id="dialog-change-layeranimation" title="Save Layer Animation" style="display:none;">
							...
							_uge(' or save as a new Animation?',REVSLIDER_TEXTDOMAIN)?></p>
						</div>

						<div id="dialog-change-layeranimation-save-as" title="Save as" style="display:none;">
							<p>
								<?php _uge('Save as Animation:',REVSLIDER_TEXTDOMAIN)?><br />
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
									<span><?php _uge("Layer Links & Advanced Params",REVSLIDER_TEXTDOMAIN)?> </span>
								</h3>
								<div class="toggled-content tp-closedatstart tp-closeifotheropen">

									<ul class="list_settings">
										<li class="custom attributes_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Links (optional)",REVSLIDER_TEXTDOMAIN)?></span>
											<!--<hr>-->
										</li>
										...
										<li id="" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Caption Sharp Corners (optional only with BG color)",REVSLIDER_TEXTDOMAIN)?></span>
											<!--<hr>-->
										</li>
										<div class="layer-links">
											<?php
										...
										<li id="" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Advanced Responsive Settings",REVSLIDER_TEXTDOMAIN)?></span>
											<!--<hr>-->
										</li>
										<div class="layer-links">
											<?php
										...
										<li id="custom_attributes" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php _uge("Attributes (optional)",REVSLIDER_TEXTDOMAIN)?></span>
											<!--<hr>-->
										</li>
										<?php
											$s = $settingsLayerOutput;
	...
	<div id="dialog_template_insert" class="dialog_template_help" title="<?php _uge("Template Insertions",REVSLIDER_TEXTDOMAIN) ?>" style="display:none;">
		<b><?php _uge("Post Replace Placeholders:",REVSLIDER_TEXTDOMAIN) ?></b>
		<table class="table_template_help">
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('meta:somemegatag')">%meta:somemegatag%</a></td><td><?php _uge("Any custom meta tag",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('title')">%title%</a></td><td><?php _uge("Post Title",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('excerpt')">%excerpt%</a></td><td><?php _uge("Post Excerpt",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('alias')">%alias%</a></td><td><?php _uge("Post Alias",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('content')">%content%</a></td><td><?php _uge("Post content",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('link')">%link%</a></td><td><?php _uge("The link to the post",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('date')">%date%</a></td><td><?php _uge("Date created",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('date_modified')">%date_modified%</a></td><td><?php _uge("Date modified",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('author_name')">%author_name%</a></td><td><?php _uge("Author name",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('num_comments')">%num_comments%</a></td><td><?php _uge("Number of comments",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('catlist')">%catlist%</a></td><td><?php _uge("List of categories with links",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('taglist')">%taglist%</a></td><td><?php _uge("List of tags with links",REVSLIDER_TEXTDOMAIN) ?></td></tr>
		</table>
		<?php if(UniteEmRev::isEventsExists()):?>

		<br><br>

		<b><?php _uge("Events Placeholders:",REVSLIDER_TEXTDOMAIN) ?></b>
		<table class="table_template_help">
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_start_date')">%event_start_date%</a></td><td><?php _uge("Event start date",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_end_date)">'%event_end_date%</a></td><td><?php _uge("Event end date",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_start_time')">%event_start_time%</a></td><td><?php _uge("Event start time",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_end_time)">'%event_end_time%</a></td><td><?php _uge("Event end time",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_event_id')">%event_event_id%</a></td><td><?php _uge("Event ID",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_name')">%event_location_name%</a></td><td><?php _uge("Event location name",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_slug%')">%event_location_slug%</a></td><td><?php _uge("Event location slug",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_address)">%event_location_address%</a></td><td><?php _uge("Event location address",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_town')">%event_location_town%</a></td><td><?php _uge("Event location town",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_state')">%event_location_state%</a></td><td><?php _uge("Event location state",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_postcode')">%event_location_postcode%</a></td><td><?php _uge("Event location postcode",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_region')">%event_location_region%</a></td><td><?php _uge("Event location region",REVSLIDER_TEXTDOMAIN) ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_country')">%event_location_country%</a></td><td><?php _uge("Event location country",REVSLIDER_TEXTDOMAIN) ?></td></tr>
		</table>
