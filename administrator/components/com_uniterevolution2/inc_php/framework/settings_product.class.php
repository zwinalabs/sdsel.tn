	...
	class UniteSettingsRevProductRev extends UniteSettingsOutputRev{
		...
		protected function drawImageInput($setting){
			...
			?>
				...
				<input type="button" id="<?php echo $buttonID?>" style="width: 110px !important; float: left;" class='button-image-select button-primary revblue<?php echo $class?>' value="<?php _uge('Choose Image',REVSLIDER_TEXTDOMAIN); ?>"></input>
				<input type="button" class="button-image-remove button-primary revred" style="width: 110px !important;" id="<?php echo $buttonRemoveID; ?>" value="<?php _uge('Remove',REVSLIDER_TEXTDOMAIN); ?>" />
				<div class="clear"></div>
			<?php
		}
