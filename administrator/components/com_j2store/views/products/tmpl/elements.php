				...
				<tr>
					...
					<td>
						<a href="javascript:void(0)"
							onclick="window.parent.jSelectItem('<?php echo $item->j2store_product_id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$item->product_name); ?>', '<?php echo JRequest::getCmd('object', 'id'); ?>');"
							>
