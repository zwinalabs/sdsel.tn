...
class SppagebuilderAddonTweet extends SppagebuilderAddons {
	...
	public function render() {
		...
		if(count((array) $tweets)>0) {
			...
			$output .= ($show_avatar) ? '<a target="_blank" rel="noopener noreferrer" href="https://twitter.com/'. $tweets[0]->user->screen_name .'"><img class="sppb-img-circle sppb-tweet-avatar" src="'. $tweets[0]->user->profile_image_url_https .'" alt="'. $tweets[0]->user->name .'"></a>' : '';
