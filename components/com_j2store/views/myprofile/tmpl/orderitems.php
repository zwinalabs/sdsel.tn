...
<div style="page-break-inside: avoid;">
    ...
    <table style="border-collapse: collapse;" class="emailtemplate-table table table-bordered" width="100%" border="0" cellspacing="0" cellpadding="0">
        <thead>
        <tr>
            <th style="font-family: 'Arial';line-height: 1.35em;padding: 7px 9px 9px;border: 1px solid #ccc;"><?php echo JText::_('J2STORE_CART_LINE_ITEM'); ?></th>
            <th style="font-family: 'Arial';line-height: 1.35em;padding: 7px 9px 9px;border: 1px solid #ccc;"><?php echo JText::_('J2STORE_CART_LINE_ITEM_QUANTITY'); ?></th>
            <?php if(isset($this->taxes) && count($this->taxes) && $this->params->get('show_item_tax', 0)): ?>
                <?php $colspan = '3'; ?>
                <th style="font-family: 'Arial';line-height: 1.35em;padding: 7px 9px 9px;border: 1px solid #ccc;"><?php echo JText::_('J2STORE_CART_LINE_ITEM_TAX'); ?></th>
            <?php endif; ?>
            <th style="font-family: 'Arial';line-height: 1.35em;padding: 7px 9px 9px;border: 1px solid #ccc;"><?php echo JText::_('J2STORE_CART_LINE_ITEM_TOTAL'); ?></th>
        </tr>
        </thead>
