    ...
    <div class="j2store-product-images j2store-product-images-<?php echo $this->product->j2store_product_id; ?>">
        ...
        <?php if($this->params->get('show_thumbnail_image', 0)):?>
            <div class="j2store-thumbnail-image">
                ...
                <?php if(isset($thumb_image) &&  JFile::exists(JPATH_SITE.'/'.$thumb_image)):?>
                    ...
                    <?php endif;?>
                    <span>
		   		<img alt="<?php echo (!empty($this->product->thumb_image_alt)) ? $this->product->thumb_image_alt : $this->product->product_name; ?>" title="<?php echo $this->product->product_name ;?>" class="j2store-product-thumb-image-<?php echo $this->product->j2store_product_id; ?>"  src="<?php echo $image_path.$thumb_image;?>" />
		  	 </span>
                    <?php if($this->params->get('category_link_image_to_product',0) == 1):?>
                        </a>
                    <?php endif;?>
        ...
        <?php if($this->params->get('show_main_image', 0)):?>
            <div class="j2store-mainimage">
		  	 ...
		  	 <img alt="<?php echo (!empty($this->product->main_image_alt)) ? $this->product->main_image_alt : $this->product->product_name; ?>" title="<?php echo $this->product->product_name ;?>" class="j2store-product-main-image-<?php echo $this->product->j2store_product_id; ?>"  src="<?php echo $image_path.$main_image;?>" />
		  	 </span>
                        <?php if($this->params->get('category_link_image_to_product',0) == 1):?>
                    </a>
                <?php endif;?>
