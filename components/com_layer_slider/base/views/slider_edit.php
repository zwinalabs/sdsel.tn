...
<form method="post" id="ls-slider-form" novalidate="novalidate" autocomplete="off">
	...
	<div class="wrap">
		...
		<div id="ls-main-nav-bar">
			...
			<a href="http://docs.offlajn.com/creative-slider" target="_blank" class="support right unselectable">
	...
	<div id="ls-pages">
		...
		<div class="ls-page ls-callback-page">
			...
			<div class="ls-notification-info">
				...
				<?php echo sprintf(__('Please read our %sonline documentation%s before start using the API. LayerSlider 6 introduced an entirely new API model with different events and methods.', 'LayerSlider'), '<a href="http://docs.offlajn.com/creative-slider#layerslider-api" target="_blank">', '</a>') ?>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="sliderWillLoad" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event) {\n\t\n}" ?></textarea>
				</div>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="slideTimelineDidCreate" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event, slider) {\n\t\n}" ?></textarea>
				</div>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="popupWillOpen" data-event-data="false" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event, slider) {\n\t\n}" ?></textarea>
				</div>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="popupDidOpen" data-event-data="false" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event, slider) {\n\t\n}" ?></textarea>
				</div>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="popupWillClose" data-event-data="false" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event, slider) {\n\t\n}" ?></textarea>
				</div>
			</div>
			...
			<div class="ls-box ls-callback-box">
				...
				<div>
					<textarea name="popupDidClose" data-event-data="false" cols="20" rows="5" class="ls-codemirror"><?php echo "function(event, slider) {\n\t\n}" ?></textarea>
				</div>
			</div>
