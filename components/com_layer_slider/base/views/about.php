	...
	<div class="km-tabs-content">
		...
		<div>
			...
			<div class="km-tabs-inner">
				<ul>
					<li class="gap">
						<a href="http://docs.offlajn.com/creative-slider#updating" target="_blank">
					...
					<li class="gap">
						<a href="http://docs.offlajn.com/creative-slider#demo-sliders" target="_blank">
					...
					<li class="gap">
						<a href="http://docs.offlajn.com/creative-slider#overview" target="_blank">
						...
						<ul>
							<li>
								<a href="http://docs.offlajn.com/creative-slider" target="_blank">
				...
				<div class="five-col clearfix">
					<div class="col">
						...
						<ul>
							...
							<li>
								<a href="http://docs.offlajn.com/creative-slider#support" targee="_blank">
					...
					<div class="col">
						...
						<ul>
							...
							<li>
								<a href="http://docs.offlajn.com/creative-slider#troubleshooting" target="_blank">
