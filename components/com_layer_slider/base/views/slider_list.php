...
<div class="wrap" id="ls-list-page">
	<h2>Creative Slider - <?php _e('Your Sliders', 'LayerSlider') ?></h2>
			...
			<div class="ls-box ls-product-banner ls-auto-update <?php echo  $validity ? 'active' : '' ?>">
				...
				<div class="inner guide">
					<p>
						...
						<a target="_blank" href="http://docs.offlajn.com/creative-slider#activation"><?php _e('Click here to learn more', 'LayerSlider') ?></a>
						<?php else : ?>
				...
				<form method="post" class="inner">
					...
					<div class="main-controls">
						...
						<a target="_blank" class="button button-small where-button" href="http://docs.offlajn.com/creative-slider#activation-purchase-code"><?php _e('Where’s my purchase code?', 'LayerSlider') ?></a>
						...
						<p>
							<?php if( $GLOBALS['lsAutoUpdateBox'] == false ) {
								echo sprintf(__('It seems you’ve received LayerSlider by a theme. Please note, the activation only works if you’ve purchased LayerSlider directly from Kreatura. %sPurchase a license%s or read our %sactivation guide%s.', 'LayerSlider'), '<a href="http://codecanyon.net/cart/add_items?ref=kreatura&amp;item_ids=1362246" target="_blank">', '</a>', '<a href="http://docs.offlajn.com/creative-slider#activation" target="_blank">', '</a>');
							} else {
								echo sprintf(__('If you experience any issue or need further information, please read our %sactivation guide%s.', 'LayerSlider'), '<a href="http://docs.offlajn.com/creative-slider#activation" target="_blank">', '</a>');
							} ?>
						</p>
					...
					<div class="sub-options">
						...
						<div class="controls">
							...
							<!-- <a href="<?php //echo LS_REPO_BASE_URL.'download?domain='.call_user_func('base'.'64_encode', $_SERVER['SERVER_NAME']).'&channel='.$channel.'&code='.call_user_func('base'.'64_encode', $code) ?>" class="dl-link"><?php //_e('Download install file', 'LayerSlider') ?></a> -->
							<span></span>
						</div>
					</div>
				</form>
