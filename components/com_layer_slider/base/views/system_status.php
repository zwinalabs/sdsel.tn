			...
			<table>
				...
				<tbody>
					<tr class="<?php echo ! empty($authorized) ? '' : 'ls-warning' ?>">
						...
						<td>
							<?php if( ! $authorized ) : ?>
							<span><?php echo sprintf(__('Activate your copy of LayerSlider to receive updates, so you can always use the latest release with all the new features and bug fixes. %sClick here to learn more%s.', 'LayerSlider'), '<a href="http://docs.offlajn.com/creative-slider#updating" target="_blank">', '</a>') ?></span>
							<?php endif ?>
						</td>
					</tr>
					<tr>
