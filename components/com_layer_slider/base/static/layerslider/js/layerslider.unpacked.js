...
window._layerSlider = {
	...
	lsScript: jQuery( 'script[src*="layerslider.js"]' )[0],
	scriptPath: '',
	pluginsPath: false,
	...
	showNotice: function( id, issue, curVer, reqVer ){
		...
		switch(issue ){
			...
			errorText = 'It looks like that another extension or your template loads an extra copy of the jQuery library causing problems for CreativeSlider to show your sliders. Please install and configure <a href="https://extensions.joomla.org/extension/jquery-easy/" target="_blank">jQuery Easy plugin</a> to resolve jQuery conflicts.';
			break;
			case 'oldjquery':
			errorTitle = 'Old jQuery issue';
			errorText = 'It looks like you are using an old version (' + curVer + ') of the jQuery library. CreativeSlider requires at least version ' + reqVer + ' or newer. Please install and configure <a href="https://extensions.joomla.org/extension/jquery-easy/" target="_blank">jQuery Easy plugin</a> to resolve jQuery conflicts.';
			break;
		}
...
(function( $) {
				...
				global: function(){
					...
					*/
					...
					if( window.console && ls.o.hideWelcomeMessage !== true && window._layerSlider.hideWelcomeMessage !== true ){
						...
						console[method]( 'Find updates and docs @ http://docs.offlajn.com/creative-slider' );
					}
	...
	$(function(){
		$(".ls-wp-container").on("sliderDidLoad",function(){
			$("body>.ls-container:not([id])").attr("class","ls-hidden")
		})
	});
