...
<script type="text/html" id="ls-layer-template">
		...
		<div class="ls-easy">
			<ul class="layer-properties-box clearfix">
				<li class="ls-easy-tr" data-prop="transitionin">
					<h6><?php _e('Add opening transition') ?></h6>
					<h5><span><?php _e('Opening transition') ?></span></h5>
					<button type="button" class="button ls-blue-button ls-preset">
						<i class="dashicons dashicons-admin-settings"></i>
						<?php _e('Choose preset') ?>
					</button>
					<ul></ul>
					<select class="ls-add-tr-prop"><option value="">&#10010;&nbsp;&nbsp;&nbsp;<?php _e('Add property') ?></option></select>
				</li>
				<li class="ls-easy-tr" data-prop="transitionout">
					<h6><?php _e('Add ending transition') ?></h6>
					<h5><span><?php _e('Ending transition') ?></span><i class="dashicons dashicons-no"></i></h5>
					<button type="button" class="button ls-blue-button ls-preset">
						<i class="dashicons dashicons-admin-settings"></i>
						<?php _e('Choose preset') ?>
					</button>
				...
				<li class="ls-easy-tr" data-prop="loop">
					<h6><?php _e('Add loop transition') ?></h6>
					<h5><span><?php _e('Loop transition') ?></span><i class="dashicons dashicons-no"></i></h5>
					<button type="button" class="button ls-blue-button ls-preset">
						<i class="dashicons dashicons-admin-settings"></i>
						<?php _e('Choose preset') ?>
					</button>
				...
				<li class="ls-easy-tr" data-prop="hover">
					<h6><?php _e('Add hover transition') ?></h6>
					<h5><span><?php _e('Hover transition') ?></span><i class="dashicons dashicons-no"></i></h5>
					<button type="button" class="button ls-blue-button ls-preset">
						<i class="dashicons dashicons-admin-settings"></i>
						<?php _e('Choose preset') ?>
					</button>
	...
	<div class="ls-sublayer-page ls-sublayer-link">
		...
		<h3 class="subheader ls-adv"><?php _e('Custom Attributes', 'LayerSlider') ?></h3>
