		...
		<tbody class="ls-slide-options">
			...
			<tr>
				...
				<td class="slide-thumb">
					...
					<div class="inner">
						...
						<span class="indent">
							<?php _e('or') ?> <a href="#" class="ls-url-prompt"><?php _e('enter URL') ?></a> | <a href="#" class="ls-capture-slide"><?php _e('capture slide') ?></a>
						</span>
					</div>
				</td>
			...
			<tr class="ls-advanced ls-hidden">
				...
				<td class="slide-schedule">
					<h3 class="subheader"><?php _e('Slide Schedule', 'LayerSlider') ?></h3>
					<div class="inner">
						<div class="row-helper">
				...
				<td class="additional-settings">
					...
					<div class="inner">
						...
						<button type="button" class="button ls-configure-posts"><?php _e('Configure post options', 'LayerSlider') ?></button>
					</div>
				</td>
				<td class="slide-actions">
					...
					<div class="inner">
						<div class="row-helper ls-global-hover">
							<span>
								<a href="http://creativeslider.demo.offlajn.com/index.php/global-hover-example/" target="_blank">
			...
			<tr class="ls-advanced ls-hidden">
				<td class="slide-ken-burns" style="text-align: center">
					<div style="display: inline-block; vertical-align: top">
						<h3 class="subheader"><?php _e('Slide Attributes', 'LayerSlider') ?></h3>
				...
				<td class="ls-layers-list">
					<div class="ls-layers-wrapper">
						...
						<div class="ls-empty-layer-notification">
							...
							<?php _e('This slide has no layers') ?><br>
							<?php printf(__('Click %sAdd New%s to add your first layer.', 'LayerSlider'), '<span><span class="dashicons dashicons-plus"></span>', '</span>') ?>
						</div>
					</div>
				</td>
