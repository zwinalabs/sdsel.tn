...
<div class="ls-box ls-settings">
	...
	<div class="inner">
		<ul class="ls-settings-sidebar">
			...
			<li data-deeplink="popup">
				<i class="dashicons dashicons-external"></i>
				<strong><?php _e('Popup', 'LayerSlider') ?></strong><small><?php _e('NEW', 'LayerSlider') ?></small></li>
