	...
	<div id="ls-embed-modal-window">
		...
		<div class="km-ui-modal-scrollable">
			<div class="columns clearfix">
				<div class="third">
					<div>
						...
						<footer>
							<a class="button" href="http://docs.offlajn.com/creative-slider#publish-shortcode" target="_blank">
				...
				<div class="third">
					<div>
						...
						<footer>
							<a class="button" href="http://docs.offlajn.com/creative-slider#publish-widgets" target="_blank">
								<i class="dashicons dashicons-external"></i>
								<?php _e('Learn more', 'LayerSlider') ?>
							</a>
						</footer>
				...
				<div class="third">
					<div>
						...
						<footer>
							<a class="button" href="http://docs.offlajn.com/creative-slider#publish-php" target="_blank">
								<i class="dashicons dashicons-external"></i>
								<?php _e('Learn more', 'LayerSlider') ?>
							</a>
						</footer>
			...
			<div class="ls-separator">
				<div>
					<?php echo sprintf(__('To find more details about how you can embed sliders on your site please refer to our %sonline documetation%s.', 'LayerSlider'), '<a href="http://docs.offlajn.com/creative-slider" target="_blank">', '</a>') ?>
				</div>
			</div>
		</div>
	</div>
