...
function layerslider_enqueue_content_res() {
	...
	wp_register_script('layerslider', LS_ROOT_URL.'/static/layerslider/js/layerslider.js', array('jquery'), LS_PLUGIN_VERSION, $footer );
...
function layerslider_enqueue_admin_res() {
	...
	if(strpos($screen->base, 'layerslider') !== false) {
		...
		// Slider & Transition Builder
			...
			wp_enqueue_script('layerslider', LS_ROOT_URL.'/static/layerslider/js/layerslider.js', array('jquery'), LS_PLUGIN_VERSION );
			...
			wp_enqueue_script('air-datepicker', LS_ROOT_URL.'/static/air-datepicker/datepicker.min.js', array('jquery'), '2.1.0en' );
