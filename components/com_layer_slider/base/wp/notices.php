		...
		if($latest && version_compare(LS_PLUGIN_VERSION, $latest, '<')) {
			...
			<div class="layerslider_notice">
				...
				<p>
					...
					<i><?php echo sprintf(__('Set up auto-updates to upgrade to this new version, or request it from the author of your theme if you’ve received LayerSlider from them. %sClick here%s to learn more.', 'LayerSlider'), '<a href="http://docs.offlajn.com/creative-slider#updating" target="_blank">', '</a>') ?></i>
...
function layerslider_canceled_activation() { ?>
	...
	<p>
		...
		<br><br> <?php echo sprintf(__('To review all the possible reasons and find out what to do next, please refer to the %sWhy was my activation canceled?%s section in our documentation.', 'LayerSlider'), '<a target="_blank" href="http://docs.offlajn.com/creative-slider#canceled-activation">', '</a>') ?>
