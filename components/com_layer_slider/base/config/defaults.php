...
<ul>
	...
	<li>and insert the slider to the target page with one of the methods described in the <a href=\"http://docs.offlajn.com/creative-slider#publish-shortcode\" target=\"_blank\">documentation</a>.</li>
</ul>', 'LayerSlider'),
			'attrs' => array(
		...
		'playByScroll' => array(
			...
			'keys' => 'playByScroll',
			'desc' => sprintf(__('Play the slider by scrolling the web page. %sClick here%s to see a live example.', 'LayerSlider'), '<a href="http://creativeslider.demo.offlajn.com/index.php/play-by-scroll/" target="_blank">', '</a>' ),
			'premium' => true
		),
	...
	'slides' => array(
		...
		'scheduleStart' => array(
			...
			'name' => __('Start on'),
			'keys' => 'schedule_start',
			'desc' => __("Scheduled slide will only be visible to your visitors between the time period you set here.<br>We're using international date and time format to avoid ambiguity."),
			'attrs' => array(
				'placeholder' => __('No schedule')
			),
			'props' => array(
				'meta' => true
			)
		...
		'alt' => array(
			...
			'keys' => 'alt',
			'tooltip' => __('Name or describe your slide image, so search engines and VoiceOver softwares can properly identify it.', 'LayerSlider'),
			'props' => array('meta' => true),
		),
	...
	'layers' => array(
		...
		'textTypeIn' => array(
			'value' => 'chars_asc',
			'name' => __('Text Animation', 'LayerSlider'),
			'keys' => 'texttypein',
		...
		'transitionStatic' => array(
			'value' => 'none',
			'name' => __('Static layer', 'LayerSlider'),
			'keys' => 'static',
			...
			'options' => array(
				'none' => __('Disabled (default)', 'LayerSlider'),
				'forever' => __('Enabled (never animate out)', 'LayerSlider')
			)
		),
