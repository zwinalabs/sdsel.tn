...
/**
 * Helper for mod_jbvertical_tabs
 *
 * @package     Joomla.Site
 * @subpackage  mod_jbvertical_tabs
 *
 * @since       1.6
 */
abstract class ModJBVerticalTabsHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item)
		{
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->linkText = JText::_('MOD_JBVERTICAL_TABS_READMORE');
			}
			else
			{
				...
				$item->linkText = JText::_('MOD_JBVERTICAL_TABS_READMORE_REGISTER');
			}

			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_jbvertical_tabs.content');
