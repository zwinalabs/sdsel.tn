...
//assigning module id
$slider_id = 'jowl-module-jbmedia-style6-slider-'.$module->id;
...
jQuery(document).ready(function($) {
    var style6owl = $("#<?php echo $slider_id;?>");
   // $('.owl-item').addClass('animated bounceOutLeft');
    style6owl.owlCarousel({
...
<div id="jb-responsive-testimonal-style6-<?php echo $module->id;?>" class="jbt-style-6 <?php echo $moduleclass_sfx; ?>">				
