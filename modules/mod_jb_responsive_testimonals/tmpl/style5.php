...
//assigning module id
$slider_id = 'jowl-module-jbmedia-style5-slider-'.$module->id;
...
jQuery(document).ready(function($) {
    var style5owl = $("#<?php echo $slider_id;?>");
   // $('.owl-item').addClass('animated bounceOutLeft');
    style5owl.owlCarousel({
...
<div id="jb-responsive-testimonal-style5-<?php echo $module->id;?>" class="jbt-style-5<?php echo $moduleclass_sfx; ?>">
	<div class="jb-responsive-testimonal-item-wrapper ">
		<div id="<?php echo $slider_id;?>" 	class="owl-carousel1 jb-responsive-testimonial-list">
			<!-- Testimonals items   -->
			<?php foreach($list as $i => $item):?>	
				...
				<p class="jbt-quote">
					<span
						id="jb-responsive-testimonial-bq-<?php echo $module->id;?>-<?php echo $i;?>"
						class="jb-responsive-testimonal-quote">
							<?php echo $item->quote; ?>
						</span>
				</p>
				<br />
				...
				<p class="jb-responsive-testimonal-head">
					<span class="jbt-avatar-name"><?php echo $item->name;?></span> , <span
						class="jbt-avatar-company"> <?php echo $item->company ;?></span>
				</p>
