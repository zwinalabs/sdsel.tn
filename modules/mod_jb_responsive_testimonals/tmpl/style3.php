...
//assigning module id
$slider_id = 'jowl-module-jbmedia-style3-slider-'.$module->id;
   ...
   // $('.owl-item').addClass('animated bounceOutLeft');
    style3owl.owlCarousel({
    	 ...
    	 singleItem : <?php echo $singleItem;?>, 
    		//Basic Speeds
         slideSpeed : <?php echo (int) $slideSpeed;?>,
         paginationSpeed :<?php echo (int) $slideSpeed;?>,
         rewindSpeed : 1000,               
...
<div id="jb-responsive-testimonal-style3-<?php echo $module->id;?>" class="jbt-style-3 <?php echo $moduleclass_sfx; ?>">				
			...
			<?php foreach($list as $i => $item):?>	
				<div  id="jb-testimonial-list-image-<?php echo $module->id;?>-<?php echo $i;?>" class="jbt-avatar item" >			 			
					...
					<p class="jb-responsive-testimonal-head">
						<span class="jbt-avatar-name">
							<?php echo $item->name;?>
						</span> ,
						<span class="jbt-avatar-company">
